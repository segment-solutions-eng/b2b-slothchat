document.addEventListener("DOMContentLoaded", function () {
  ...
  const actionUsModal = new bootstrap.Modal(
  ...
  const contactUsModal = new bootstrap.Modal(
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var showDetailsButton = document.querySelector(
